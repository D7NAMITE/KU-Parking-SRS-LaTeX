...
\def \srsTitle{KU Parking (End-of-Semester Progress Report)}
\def \srsAuthorOne{Nanthawat Duang-ead}
\def \srsAuthorTwo{Setthapon Thadisakun}
\def \srsAuthorThree{}
\def \srsAcademicYear{2026}

\def \srsAdvisorName{Assoc. Prof. Dr. Chaiporn Jaikaeo}
...
\begin{document}
    ...
    % \include{body/acknowledgement} % TODO: Remove the comment in-full version
    ...
    \include{body/end-of-semester-report/summary}
    \include{body/end-of-semester-report/developmentprogress}
    %% Chapters section
