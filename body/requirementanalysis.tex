...
}{verify that computer vision can accurately detect parking availability from standard camera angles% 
}{I can provide parking information to visitors}
...
\userstory{Manual Model Output Calibration% 
}{parking area administrator% 
}{I want to manually adjust the detection areas on the live feed% 
}{I can fix spots that don't align with the real-world layout}
