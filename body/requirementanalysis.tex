...
Figure 3.2 presents the user interface design for navigation. Users can select a parking area from either the map or the drawer list and navigate from their current location to the chosen parking area.
